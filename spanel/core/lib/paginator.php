    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
           // $html .= '<li><a href="' . htmlspecialchars($this->getPrevUrl()) . '">&laquo; '. $this->previousText .'</a></li>';
            //$html .= '<a href="' . htmlspecialchars($this->getPrevUrl()) . '"> <button type="button" class="btn btn-secondary waves-effect">   &laquo; '. $this->previousText .' </button>  </a>';
        }

//$html .= '<div class="btn-group m-b-10">';
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
               ...
               // $html .= '<a href="' . htmlspecialchars($page['url']) . '"> <button type="button" class="btn ' . ($page['isCurrent'] ? 'btn-primary waves-light"' : 'btn-secondary') . ' waves-effect">  ' . htmlspecialchars($page['num']) . ' </button>  </a>';
            } else {
                $html .= '<li class="page-item"><a class="page-link" href="' . htmlspecialchars($page['url']) . '"> ' . htmlspecialchars($page['num']) . '</a></li>';
               // $html .= '<button type="button" class="btn btn-secondary waves-effect ">' . htmlspecialchars($page['num']) . '</button> ';
            }
        }
//$html .= '</div>';
...
//$html .= '<div class="btn-group m-b-10">';
     ...
     if ($this->getNextUrl()) {
          //  $html .= '<li><a href="' . htmlspecialchars($this->getNextUrl()) . '">'. $this->nextText .' &raquo;</a></li>';
            //$html .= '<a href="' . htmlspecialchars($this->getNextUrl()) . '"> <button type="button" class="btn btn-secondary waves-effect"> '. $this->nextText .' &raquo;</button>  </a>';
        }
