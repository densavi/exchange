	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Deposit List</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
			...
			<div class="card mb-5 mb-xl-8">
				...
				<div class="card-body py-3">
					...
					<div class="table-responsive">
						<!--begin::Table-->
						<table class="table table-row-dashed align-middle gs-0 gy-3 table-striped">
							<!--begin::Table head-->
							<thead>
								<tr class="fw-bold text-muted">
									...
									<th class="min-w-120px">Paid Out</th>
								</tr>
							</thead>
							<!--end::Table head-->
							<!--begin::Table body-->
