<?php
	...
	$sql_query = db::super_query("SELECT * FROM `orders` WHERE user_id = '{$myProfile['id']}' ORDER BY id DESC LIMIT 10", true);
	...
	if($sql_query){
		...
		die('<div class="orders_noHis">No historical orders</div>');
